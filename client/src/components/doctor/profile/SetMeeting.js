	...
	render() {
		...
		return (
			<div>
				...
				Ici, vous pouvez organiser un rdv avec votre médecin. Sélectionnez 
                jour, heure disponible, et venez ce jour-là
					</Typography>
				<div className={`${classes.container} flex`}>
					<FormControl>
						<InputLabel>Sélectionner un jour</InputLabel>
						<Select
					...
					<FormControl disabled={!this.state.allowed}>
						<InputLabel>Séléctionnez l'horaire qui vous convient</InputLabel>
						<Select
				...
				<Snackbar
					...
					message={
						<span id="message-id">votre visite a été enregistré!</span>
					}
					action={[
						<IconButton
							key="close"
